...
public class ProjectDetailJobAdapter extends RecyclerView.Adapter<BaseViewHolder> {

    private static final int VIEW_TYPE_NORMAL = 0;
    private static final int VIEW_TYPE_EMPTY = 1;


    private ProjectDetailJobAdapter.Callback callback;
    private List<Job> jobList;

    public ProjectDetailJobAdapter(List<Job> jobList) {
        this.jobList = jobList;
    }

    public void setCallback(ProjectDetailJobAdapter.Callback callback) {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_NORMAL:
                return new ProjectDetailJobAdapter.ViewHolder(
                        LayoutInflater.from(parent.getContext()).inflate(R.layout.catalog_item, parent, false));
            case VIEW_TYPE_EMPTY:
            default:
                return new ProjectDetailJobAdapter.EmptyViewHolder(
                        LayoutInflater.from(parent.getContext()).inflate(R.layout.catalog_item, parent, false));
        }
    }
