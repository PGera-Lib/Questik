...
public class ProjectDetailMaterialAdapter extends RecyclerView.Adapter<BaseViewHolder> {

    private static final int VIEW_TYPE_NORMAL = 0;
    private static final int VIEW_TYPE_EMPTY = 1;


    private ProjectDetailMaterialAdapter.Callback callback;
    private List<Job> jobList;

    public ProjectDetailMaterialAdapter(List<Job> jobList) {
        this.jobList = jobList;
    }

    public void setCallback(ProjectDetailMaterialAdapter.Callback callback) {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_NORMAL:
                return new ProjectDetailMaterialAdapter.ViewHolder(
                        LayoutInflater.from(parent.getContext()).inflate(R.layout.catalog_item, parent, false));
            case VIEW_TYPE_EMPTY:
            default:
                return new ProjectDetailMaterialAdapter.EmptyViewHolder(
                        LayoutInflater.from(parent.getContext()).inflate(R.layout.catalog_item, parent, false));
        }
    }
